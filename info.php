...
<body>
    ...
    if (isset($_GET['id_peli']) && $_GET['id_peli'] > 0) {
        ...
        echo '/><label for="rating10" title="10/10"></label>
        ...
        echo '/><label class="half" for="rating9" title="9/10"></label>
        ...
        echo '/><label for="rating8" title="8/10"></label>
        ...
        echo '/><label class="half" for="rating7" title="7/10"></label>
        ...
        echo '/><label for="rating6" title="6/10"></label>
        ...
        echo '/><label class="half" for="rating5" title="5/10"></label>
        ...
        echo '/><label for="rating4" title="4/10"></label>
        ...
        echo '/><label class="half" for="rating3" title="3/10"></label>
        ...
        echo '/><label for="rating2" title="2/10"></label>
        ...
        echo '/><label class="half" for="rating1" title="1/10"></label>
                                        </fieldset>
        ...
        } else if ($row_datos['temporada'] == 1) {
            echo 'Serie de ' . $row_datos['temporada'] . ' temporada';
        } else {
            echo '' . $row_datos['duracion'] . ' minutos';
        }
        echo '</p>
                                    </div>
                                </div>
        ...
        if ($_SESSION['administrador'] == 0) {
            ...
            if (isset($_SESSION['id_usuario'])) {
                ...
                echo ' </form> <button class="publicar" id="review-sin-sesion" >Publicar</button>';
            };
            echo '
                </div>';
        }
        ...
        if ($q_reseñas->num_rows > 0) {
            while ($row = $q_reseñas->fetch_assoc()) {
                            ...
                            <div id="cont">
                                ...
                                <div id="estre-review" >
                                    <fieldset class="rateDisplay rateChico">
                                        <input type="radio" id="rating10" name="rating' . $contName . '" value="10" ';
                if ($estrellas == 10) {
                    echo 'checked';
                } else {
                    echo 'onclick="return false;"';
                ...
                echo '/><label for="rating10" title="10/10"></label>
                                        <input type="radio" id="rating9" name="rating' . $contName . '" value="9" ';
                if ($estrellas >= 9  && $estrellas < 10) {
                    echo 'checked';
                } else {
                    echo 'onclick="return false;"';
                }
                echo '/><label class="half" for="rating9" title="9/10"></label>
                                        <input type="radio" id="rating8" name="rating' . $contName . '" value="8" ';
                if ($estrellas >= 8 && $estrellas < 9) {
                    echo 'checked';
                } else {
                    echo 'onclick="return false;"';
                }
                echo '/><label for="rating8" title="8/10"></label>
                                        <input type="radio" id="rating7" name="rating' . $contName . '" value="7" ';
                if ($estrellas >= 7 && $estrellas < 8) {
                    echo 'checked';
                } else {
                    echo 'onclick="return false;"';
                }
                echo '/><label class="half" for="rating7" title="7/10"></label>
                                        <input type="radio" id="rating6" name="rating' . $contName . '" value="6" ';
                if ($estrellas >= 6  && $estrellas < 7) {
                    echo 'checked';
                } else {
                    echo 'onclick="return false;"';
                }
                echo '/><label for="rating6" title="6/10"></label>
                                        <input type="radio" id="rating5" name="rating' . $contName . '" value="5" ';
                ...
                echo '/><label class="half" for="rating5" title="5/10"></label>
                                        <input type="radio" id="rating4" name="rating' . $contName . '" value="4" ';
                ...
                echo '/><label for="rating4" title="4/10"></label>
                                        <input type="radio" id="rating3" name="rating' . $contName . '" value="3" ';
                if ($estrellas >= 3 && $estrellas < 4) {
                    echo 'checked';
                } else {
                    echo 'onclick="return false;"';
                }
                echo '/><label class="half" for="rating3" title="3/10"></label>
                                        <input type="radio" id="rating2" name="rating' . $contName . '" value="2" ';
                if ($estrellas >= 2 && $estrellas < 3) {
                    echo 'checked';
                } else {
                    echo 'onclick="return false;"';
                }
                echo '/><label for="rating2" title="2/10"></label>
                                        <input type="radio" id="rating1" name="rating' . $contName . '" value="1" ';
